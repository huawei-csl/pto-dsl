...
def build_gather_kernel(fn_name="vec_gather_kernel", dtype=None, rows=32, cols=32):
    ...
    def _kernel(
        ...
        with pto.vector_section():
            ...
            pto.gather(
                tb2, tb3, mask_pattern="P1111"
            )  # mask-gather:  copy all lanes into tb3
