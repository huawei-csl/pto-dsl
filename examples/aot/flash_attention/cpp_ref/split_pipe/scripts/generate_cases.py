...
_SPLIT_PIPE_DIR = Path(__file__).resolve().parent.parent
...
def main() -> None:
    ...
    parser.add_argument(
        "--output-header",
        default=str(_SPLIT_PIPE_DIR / "generated_cases.h"),
        help="Output header path (default: split_pipe/generated_cases.h)",
    )
    parser.add_argument(
        "--output-json",
        default=str(_SPLIT_PIPE_DIR / "build" / "generated_cases.json"),
        help="Output JSON path (default: split_pipe/build/generated_cases.json)",
    )
    parser.add_argument(
        "--causal-mask",
        default=False,
