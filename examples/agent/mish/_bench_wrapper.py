...
Loads mish_lib.so and prints:  latency_ms=<number>
"""
import ctypes
...
xs_ = [torch.randn(BATCH, N_COLS, device=device, dtype=dtype).clamp(-4, 4) for _ in range(WARMUP + ITERS)]
